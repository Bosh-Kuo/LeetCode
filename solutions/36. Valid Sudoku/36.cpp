...
note: 將9宮格, rows, columns 的每一個要檢查的數字以 hash table 儲存，當其中一者的某個帶檢查數字出現不只一次，代表為 invalid Sudoku
ref: https://leetcode.com/problems/valid-sudoku/solutions/2841310/c-use-hashmap-easy-efficient-solution/?orderBy=hot&languageTags=cpp
*/
